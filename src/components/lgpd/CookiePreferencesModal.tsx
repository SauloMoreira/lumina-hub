...
const COOKIE_CATEGORIES: Array<{
...
}> = [
  {
    ...
    cookies: [
      { name: 'lm-auth-token', purpose: 'Sessão de login', duration: 'Sessão', provider: 'Supabase' },
      { name: 'led-marica-cart', purpose: 'Itens do carrinho', duration: '30 dias', provider: 'Led Maricá' },
      { name: 'lm-cookie-consent', purpose: 'Preferências de consentimento', duration: '365 dias', provider: 'Led Maricá' },
    ],
    locked: true,
  },
  {
    ...
    cookies: [
      { name: '_ga / _ga_*', purpose: 'Google Analytics — medição de tráfego', duration: '2 anos', provider: 'Google' },
      { name: '_clck / _clsk', purpose: 'Microsoft Clarity — mapa de calor', duration: '1 ano', provider: 'Microsoft' },
    ],
    locked: false,
  },
  {
    ...
    cookies: [
      { name: '_fbp / _fbc', purpose: 'Meta Pixel — rastreamento de conversões', duration: '90 dias', provider: 'Meta' },
      { name: '_gcl_*', purpose: 'Google Ads — atribuição de conversão', duration: '90 dias', provider: 'Google' },
    ],
    locked: false,
  },
  {
    ...
    cookies: [
      { name: 'lm-recent-views', purpose: 'Produtos vistos recentemente', duration: '30 dias', provider: 'Led Maricá' },
      { name: 'lm-ai-prefs', purpose: 'Preferências do chat com IA', duration: '90 dias', provider: 'Led Maricá' },
    ],
    locked: false,
  },
];
...
export function CookiePreferencesModal() {
  const { showPreferences, preferences, savePreferences, closePreferences, acceptAll } = useCookieStore();
      ...
      >
        ...
        <div className="overflow-y-auto p-5 space-y-3 flex-1">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Escolha quais categorias de cookies deseja permitir. Os necessários não podem ser desativados.
            Para detalhes, consulte nossa{' '}
