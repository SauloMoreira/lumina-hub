...
export function FieldError({ message }: { message?: string }) {
  ...
  return (
    <p className="text-[12px] mt-1.5" style={{ color: "#DC2626" }}>
      {message}
    </p>
  );
}
...
export function PrimaryButton({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!loading) e.currentTarget.style.backgroundColor = "#1348C0";
      }}
      onMouseLeave={(e) => {
  ...
  return (
    ...
    >
      <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.5l6.2 5.2C41 35.7 44 30.3 44 24c0-1.3-.1-2.3-.4-3.5z"
        />
      </svg>
